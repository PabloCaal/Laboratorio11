 ...
 * VARIABLES 
 ------------------------------------------------------------------------------*/
int LECTURA_POT;               // Variable de contador que envía el maestro al esclavo
...
void __interrupt() isr (void){
    ...
    if(PIR1bits.SSPIF){                 // ¿Recibió datos el esclavo?
        ...
        PIR1bits.SSPIF = 0;             // Limpieza de bandera de interrupción
    }
    return;
}
...
void setup(void){       
    ...
    TRISA = 0b10100001;         // SS y RA7 como entradas
